...
if __name__ == "__main__":
    ...
    t1 = threading.Thread(target=main3, args=(easy_getter, db_lock))
    t2 = threading.Thread(target=main3, args=(sodimac_getter, db_lock))
    t3 = threading.Thread(target=main3, args=(autoplanet_getter, db_lock))
    t1.start()
    t2.start()
    t3.start()
